...
function scopeHint(_scope) {
  return reviewData.scopeHint || "Review changes. Hover or click line numbers in the gutter to add an inline comment.";
}
...
function statusBadgeClass(status) {
  switch (status) {
    case "added": return "text-review-success";
    case "deleted": return "text-review-error";
    case "renamed": return "text-review-warning";
...
function renderTreeNode(node, depth) {
  ...
  for (const child of children) {
    ...
    button.className = [
      ...
      file.id === state.activeFileId ? "bg-review-active text-review-strong" : reviewed ? "text-review-text hover:bg-review-hover" : "text-review-muted hover:bg-review-hover hover:text-review-text",
    ].join(" ");
...
function renderSearchResults(files) {
  files.forEach((file) => {
    ...
    button.className = [
      ...
      file.id === state.activeFileId ? "bg-review-active text-review-strong" : "text-review-text hover:bg-review-hover",
    ].join(" ");
    button.innerHTML = `
...
function canCommentOnSide(file, side) {
  ...
  return comparison != null && comparison.hasModified;
}
