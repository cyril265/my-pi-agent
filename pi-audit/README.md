...
- `pi-audit update [package]` — update matching managed package by package name, original source, or audited snapshot path; with no package, updates all managed packages.
